...
import { getAllEvents, getOrderbook } from "../../Apis/Event";
...
const Event = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 mx-4 sm:mx-8">
      {events.map((event) => (
        <div
          key={event._id}
        ...
        >
          ...
          <div className="flex space-x-1 sm:space-x-2 h-full items-end">
